...
class userRecord {
	...
	* @return userRecord
	*/
	 public function userRecord($error='',$id=0,$auth='',$confirmed=0,$policyagreed=0,$deleted=0,$username='',$idnumber='',$firstname='',$lastname='',$email='',$icq='',$emailstop=0,$skype='',$yahoo='',$aim='',$msn='',$phone1='',$phone2='',$institution='',$department='',$address='',$city='',$country='',$lang='',$timezone='',$mnethostid=0,$lastip='',$theme='',$description='',$role=0,$profile=array()){
		 $this->error=$error   ;
		 $this->id=$id   ;
		 $this->auth=$auth   ;
