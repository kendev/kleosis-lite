...
class resourceRecord {
	...
	*/
	 public function resourceRecord($error='',$id=0,$name='',$course=0,$type='',$reference='',$summary='',$alltext='',$popup='',$options='',$timemodified=0,$section=0,$visible=0,$groupmode=0,$coursemodule=0,$url='',$timemodified_ut='',$groupingid=0,$groupmembersonly=0){
		 $this->error=$error   ;
		 $this->id=$id   ;
		 $this->name=$name   ;
		 $this->course=$course   ;
